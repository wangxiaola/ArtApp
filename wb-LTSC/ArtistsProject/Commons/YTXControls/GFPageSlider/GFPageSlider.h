...
@property (nonatomic) UIColor *menuBackColor; //!< 标题栏背景色
@property (nonatomic,copy) void(^didPageChangedBlock)(GFPageSlider*, NSInteger);
@property (nonatomic,readwrite) NSInteger selectedPageIndex;
@property (nonatomic) BOOL isHideLine;
