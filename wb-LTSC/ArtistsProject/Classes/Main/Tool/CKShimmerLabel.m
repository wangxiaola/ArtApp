...
- (void)myInit {
    ...
    self.shimmerType = ST_AutoReverse;
    self.repeat = true;
    self.shimmerWidth = 30;
...
//        _contentLabel.textColor = [UIColor darkGrayColor];
        _contentLabel.dk_textColorPicker = DKColorPickerWithRGB(0x030303, 0x989898);
    }
...
//        _maskLabel.textColor = [UIColor darkGrayColor];
        _maskLabel.dk_textColorPicker = DKColorPickerWithRGB(0x030303, 0x989898);
