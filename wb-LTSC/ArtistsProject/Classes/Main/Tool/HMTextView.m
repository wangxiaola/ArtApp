...
- (void)layoutSubviews
{
    ...
    attributes[NSFontAttributeName] = self.placehoderLabel.font;
    CGRect placehoderRect = [self.placehoder boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil];
