...
- (void)handleLongPressTap:(CGPoint)touchPoint{
   [_photoBrowser performSelector:@selector(longPress) withObject:nil afterDelay:0.0];
}
...
- (void)imageView:(UIImageView *)imageView longPressTapDetected:(UILongPressGestureRecognizer *)longPress
{
   [self handleLongPressTap:[longPress locationInView:imageView]];
}
