...
@property (nonatomic, assign) BOOL changeBtnH;
@property (nonatomic, assign) BOOL changeBtnBGColor;

@property (nonatomic, assign) BOOL hasMove;
 ...
 *  点击标签，执行Block
 */
@property (nonatomic, strong) void(^clickTagBlock)(NSString *tag, NSInteger i);
