...
+ (HYBURLSessionTask *)_requestWithUrl:(NSString *)url
  ...
  if ([self shouldEncode]) {
    ...
    //特殊参数
    NSMutableDictionary* dicPramaters = [[NSMutableDictionary alloc] initWithDictionary:params];
    ...
    [dicPramaters setObject:[self signatureWithModule:@"topiclist"] forKey:@"privatekey"];
