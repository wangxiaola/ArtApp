...
@interface DBCameraLibraryViewController () <UIPageViewControllerDataSource, UIPageViewControllerDelegate, DBCameraCollectionControllerDelegate,DBCameraCropperDelegate> {
...
@synthesize allowEditing = _useCameraSegue;
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [[[DBLibraryManager sharedInstance] defaultAssetsLibrary] assetForURL:URL resultBlock:^(ALAsset *asset) {
            ...
            if ( !weakSelf.allowEditing ) {
                ...
                DBCameraCropperViewController *cropVC=[[DBCameraCropperViewController alloc] initWithImage:image withCropScale:self.cropScale limitScaleRatio:2];
                cropVC.delegate=self;
                [weakSelf.navigationController pushViewController:cropVC animated:YES];
            }
