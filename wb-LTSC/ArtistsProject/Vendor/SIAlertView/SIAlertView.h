...
typedef void(^SIAlertViewAndItemHandler)(SIAlertView *alertView,SIAlertItem *alertItem);
...
@property (nonatomic, copy) SIAlertViewAndItemHandler action2;
@property (nonatomic, readwrite) BOOL isAutoDismiss;
@end
