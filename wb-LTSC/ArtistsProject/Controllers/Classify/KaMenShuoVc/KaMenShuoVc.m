...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    KaMenShuoCell* cell = [tableView dequeueReusableCellWithIdentifier:@"KaMenShuoCell"];
    if (cell==nil) {
        cell = [[KaMenShuoCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"KaMenShuoCell" frame:CGRectMake(0, 0, SCREEN_WIDTH, Text_HEIGHT)];
    }
