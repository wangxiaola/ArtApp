...
@interface ClassifyVcTableViewCell ()
{
    shareModel* model;
}
...
@implementation ClassifyVcTableViewCell
...
//分类
-(void)setClassifyCellDicValue:(NSDictionary *)dic{
...
-(void)btnEdit_Click{
    ...
    shareVc.shareimage = _baseImage.image;
